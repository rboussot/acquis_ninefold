class PassagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @passage.save
        format.html { redirect_to passages_url, notice: 'Passage was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @passage.update(passage_params)
        format.html { redirect_to passages_url, notice: 'Passage was successfully updated.' }
  ...
  private
    ...
    def passage_params
      params.require(:passage).permit(:oeuvre_id, :titre_passage, :video)
    end
end
